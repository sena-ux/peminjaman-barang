...
<div id="content" class="content">
    ...
    @foreach($peminjaman as $key => $value)
        ...
        <!-- Modal -->
        <div class="modal fade" id="modal-{{ $value->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalLabel-{{ $value->id }}" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                      ...
                      <div class="mb-3">
                          ...
                          @foreach($barang as $key => $row_barang)
                              <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="barang_yang_dikembalikan[]" value="{{ $row_barang->nama_barang }}" id="barang-{{ $row_barang->id }}">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" onclick="showForm()">Kembalikan</button>
                </div>
              </div>
            </div>
          </div>
