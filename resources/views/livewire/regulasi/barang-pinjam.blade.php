...
@section('action')
@can('create barang pinjam')
<a href="{{route('peminjamanBarang.index')}}" class="btn btn-outline-primary">Peminjaman</a>
@endcan
@endsection
@endsection
<div>
