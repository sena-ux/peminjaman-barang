    ...
    <div class="container-fluid">
        <div class="card card-default color-palette-box p-3 table-responsive">
            <div class="bg-black p-2 my-2 rounded d-flex justify-content-between">
                ...
                <a href="{{route('pemeliharaan.index')}}" class="btn btn-primary">Back</a>
            </div>
            <form action="{{ route('pemeliharaan.update', $pem->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <select name="sarana_id" id="" class="form-control" id="nama" aria-describedby="nameSaranaHelp"
                            ...
                            <option value="{{ $pem->sarana_id }}" selected>{{ $pem->sarana->nama_sarana }}
                            </option>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="jenis" aria-describedby="namePemeliharaanHelp"
                            placeholder="Inputkan jenis pemeliharaan." name="jenis_pemeliharaan"
                            value="{{$pem->jenis_pemeliharaan}}" required>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="date" class="form-control" id="tanggal_mulai" aria-describedby="dateHelp"
                            placeholder="Inputkan tanggal mulai pemeliharaan." name="tanggal_mulai"
                            value="{{ $pem->tanggal_mulai }}" required>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="date" class="form-control" id="tanggal_selesai" aria-describedby="dateHelp"
                            placeholder="Inputkan tanggal selesai pemeliharaan." name="tanggal_selesai"
                            value="{{$pem->tanggal_selesai}}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="biaya" aria-describedby="biayaHelp"
                                value="{{$pem->biaya}}" required>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="sumberDana" aria-describedby="sumberdanaHelp"
                            name="sumber_dana" value="{{$pem->sumber_dana}}" required>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" id="penanggung_jawab"
                            aria-describedby="penanggung_jawabHelp" name="penanggung_jawab"
                            value="{{$pem->penanggung_jawab}}" required>
                    ...
                    <div class="form-group mb-3 col-md-6">
                        <label for="kondisi_sebelum">Foto Sebelum</label>
                        <input type="file" class="form-control" id="kondisi_sebelum"
                            aria-describedby="kondisi_sebelumHelp" name="kondisi_sebelum">
                        <small id="kondisi_sebelumHelp" class="form-text text-muted">Masukkan Foto Sebelum
                            pengerjaan.</small>
                        <img src="{{asset($pem->kondisi_sebelum)}}" class="img-thumbnail" alt="Foto Sebelum">
                    ...
                    <div class="form-group mb-3 col-md-6">
                        <label for="kondisi_sesudah">Foto Sesudah</label>
                        <input type="file" class="form-control" id="kondisi_sesudah"
                            aria-describedby="kondisi_sesudahHelp" name="kondisi_sesudah">
                        <small id="kondisi_sesudahHelp" class="form-text text-muted">Masukkan Foto Sesudah
                            pengerjaan.</small>
                        <img src="{{asset($pem->kondisi_sesudah)}}" class="img-thumbnail" alt="Foto Sesudah">
                    ...
                    <div class="form-group mb-3 col-md-12">
                        ...
                        <textarea name="dokumen_pendukung" id="dokumen-pendukung" cols="30" rows="10"
                            class="form-control" style="height: 100vh;">
                        {!! $pem->dokumen_pendukung !!}
                        </textarea>
                        <div class="invalid-feedback">
                            Field wajib diisi.
                        </div>
